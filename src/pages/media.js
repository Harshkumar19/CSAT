...
export default function MediaPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        const response = await axios.get("/api/proxy?sheet=MEDIA");
        ...
        setError("Failed to fetch media data. Please try again later.");
      } finally {
        setLoading(false);
      }
    };
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm mt-1 font-medium text-gray-500">
                  Detailed view of media satisfaction scores
                </p>
              </div>
            </div>
          </div>
                ...
                >
                  {data.map((item, index) => (
                    ...
                    >
                      ...
                      >
                        {item["Optimization Effectiveness"]}
                      </td>
                      <td
                        className={`px-6 py-4 whitespace-nowrap text-sm ${
                          darkMode ? "text-gray-300" : "text-gray-900"
