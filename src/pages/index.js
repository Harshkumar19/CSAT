          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              ...
              <div
                ...
                className={`rounded-xl shadow-sm border p-6 transition-all duration-300 cursor-pointer hover:shadow-lg ${
                  darkMode
                  ...
                  <div>
                    ...
                    >
                      <div
                        ...
                        style={{ width: `${(stats.techAvg / 5) * 100}%` }}
                      ></div>
                    </div>
                  </div>
                  <div
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              ...
              >
                ...
                <div className="space-y-4">
                  {getBrandDistribution().map((brand, index) => (
                    <div
                      key={brand.brand}
